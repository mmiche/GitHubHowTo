...
6. Alle Änderungen im Verzeichnis 'meinProjekt' auf meinem Rechner, d.h. alle Änderungen in jedem dort befindlichen Dokument werden erkannt. Die geänderten Dokumente können nun über GHD zum GitHub repository transportiert (push) werden.
